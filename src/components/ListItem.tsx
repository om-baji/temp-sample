  ...
  return (
    <div className="flex bg-white rounded-lg shadow border overflow-hidden w-full">
      ...
      <div className="flex flex-col justify-center p-6 flex-1 ">
        <div className="text-xl font-bold mb-1">{project}</div>
      ...
      <div className="flex flex-col justify-center items-end p-6 min-w-[250px]">
        <div className="text-base text-gray-900 mb-1 font-semibold">Dist:{district}</div>
        <div className="text-base text-gray-900 mb-1">
          <span>No.of</span> Units: {units}
        </div>
        <div className="text-base text-gray-900 mb-1">Type of Project: {projectType}</div>
        <div className="text-base text-gray-900">Housing Type: {housingType}</div>
      </div>
    </div>
  );
};
